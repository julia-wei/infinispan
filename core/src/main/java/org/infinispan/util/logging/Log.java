 ...
 * <p/>
 * It contains explicit methods for all INFO or above levels so that they can be
 * internationalized. For the core module, message ids ranging from 00001 to
 * 2000 inclusively have been reserved.
 * <p/>
 ...
 * parameter interpolation, similar to the JDKs
 * {@link String#format(String, Object...)} method. What this means is, that the
 * following block:
